  ...
  return (
    <main className="flex-1 min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <div className="flex gap-6 mt-6">
        <a href="mailto:dor3382@gmail.com" className="text-cyan-400 hover:text-cyan-300 transition-colors">Email</a>
        <a href="https://github.com/DORI2001" className="text-cyan-400 hover:text-cyan-300 transition-colors" target="_blank">GitHub</a>
        <a href="https://www.linkedin.com/in/dor-alagem" className="text-cyan-400 hover:text-cyan-300 transition-colors" target="_blank">LinkedIn</a>
      </div>
