...
export default function Contact() {
  return (
    <div className="flex-1 min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <form action="mailto:dor3382@gmail.com" method="GET" className="flex flex-col gap-4 w-full max-w-md">
        <input type="text" placeholder="your name" className="bg-neutral-800 text-white rounded-lg p-3 font-mono text-sm" />
        <input type="email" placeholder="your email" className="bg-neutral-800 text-white rounded-lg p-3 font-mono text-sm" />
        <textarea placeholder="your message" rows={5} className="bg-neutral-800 text-white rounded-lg p-3 font-mono text-sm" />
        <button type="submit" className="bg-cyan-400 text-black font-mono font-semibold px-6 py-3 rounded-full hover:bg-cyan-300 transition-colors">
          send →
        </button>
      </form>
    </div>
